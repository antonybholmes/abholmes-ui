...
export default function ModuleButtonLink(_a) {
    ...
    return (_jsx(RoundedButtonLink, __assign({ className: cn("flex flex-col justify-start border-transparent p-2", [selected, "bg-gray-200", "hover:bg-gray-200 "], className) }, props, { children: children })));
}
