...
var IndexLink = function (_a) {
    ...
    return (_jsxs(BaseLink, __assign({ className: clns("flex flex-row gap-x-1", className) }, props, { children: [children, _jsx("div", { ref: iconEl, children: _jsx(ChevronRightIcon, { className: clns("h-full w-3 transition-transform duration-200", [
                        hover,
                        "translate-x-1",
                        "translate-x-0",
                    ]) }) })] })));
