...
export default function ArrowButtonLink(_a) {
    ...
    //     )
    // }, [hover])
    return (_jsxs(PillButtonLink, __assign({ className: clns(ARROW_BUTTON_CLS, COLOR_BUTTON_CLS, className) }, props, { children: [_jsx("span", { children: children }), _jsx(IndexArrow, { className: "w-4 stroke-2" })] })));
}
