...
var BaseLink = forwardRef(function BaseLink(_a, ref) {
    ...
    if (isExt) {
        return (_jsx(ExtLink, __assign({ ref: ref, href: href, className: clns(BASE_BUTTON_CLS, className), target: target, underline: underline }, props, { children: children })));
    }
    else {
        return (_jsx(Link, __assign({ ref: ref, href: href, className: clns(BASE_BUTTON_CLS, [underline, UNDERLINE_CLS], className) }, props, { children: children })));
    }
});
