...
var TOOLBAR_BUTTON_CLS = clns(BASE_BUTTON_CLS, CENTERED_BUTTON_CLS, FOCUS_RING_CLS, "p-2");
export default function Toolbar(_a) {
    ...
    return (_jsxs(BaseCol, { children: [_jsxs("nav", { className: clns("grid h-16 grid-cols-2 items-center border-b  px-4 lg:grid-cols-3", INPUT_BORDER_CLS, INPUT_DARK_BORDER_CLS), children: [_jsxs(VCenterRow, { className: clns("h-full w-full gap-x-2 "), children: [_jsx(DynamicSideMenu, {}), _jsx(Logo, {}), (session === null || session === void 0 ? void 0 : session.group) && (session === null || session === void 0 ? void 0 : session.user) && (_jsx("ul", { className: clns("hidden h-full grow flex-row items-center gap-x-2 pl-4 text-xs font-semibold md:flex"), children: TOOLBAR_MENU_ITEMS.map(function (menu, mi) { return (_jsx("li", { children: _jsx(BaseLink, { href: menu.url, "aria-label": menu.name, className: clns(TOOLBAR_BUTTON_CLS, [
                                            menu.name === tab,
                                            "text-sky-500",
                                            "hover:text-sky-400",
