...
export var SIDE_OVERLAY_CLS = clns("fixed inset-0 z-overlay bg-slate-900/50 dark:bg-white/10 backdrop-blur-sm duration-500 ease-in-out", "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0");
var MENU_CLS = clns("fixed left-0 top-0 z-modal h-screen w-64 bg-white dark:bg-gray-700 px-4 shadow-lg duration-500 ease-in-out fill-mode-forwards", "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in-0 data-[state=open]:slide-in-from-left-2 data-[state=closed]:fade-out-0 data-[state=closed]:slide-out-to-left-2");
