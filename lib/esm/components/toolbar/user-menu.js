...
var MENU_CLS = clns("fixed right-0 top-0 z-modal h-screen w-72 bg-background px-4", "shadow-lg duration-400 ease-in-out fill-mode-forwards duration-500", "ease-in-out fill-mode-forwards", "data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:slide-in-from-right-2", "data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:slide-out-to-right-2");
