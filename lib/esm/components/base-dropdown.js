...
export function BaseDropDown({ dropDownVisible = false, onClose, onOpenAutoFocus, menuClassName, className, children, }) {
    ...
    return (_jsxs(Popover, { open: dropDownVisible, children: [_jsx(PopoverTrigger, { asChild: true, children: children[0] }), _jsx(PopoverContent, { onInteractOutside: () => _onClose(), onEscapeKeyDown: () => _onClose(), onOpenAutoFocus: onOpenAutoFocus, className: menuClassName, children: children[1] })] }));
    {
        /* return (
