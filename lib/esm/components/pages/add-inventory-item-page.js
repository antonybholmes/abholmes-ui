...
import { ADD_INVENTORY_ITEM_URL, CENTER_CONTENT_CLS, FORM_BLOCK_CLS, FORM_CLS, FORM_DIV_CLS, INPUT_CLS, INPUT_LABEL_CLS, INVENTORY_ROUTE, STATUS_SUCCESS, } from "src/consts";
export default function AddInventoryItemPage(_a) {
    ...
    var _e = useState(""), vendor = _e[0], setVendor = _e[1];
    var _f = useState(""), unit = _f[0], setUnit = _f[1];
    var _g = useState(0), price = _g[0], setPrice = _g[1];
    var _h = useState(""), type = _h[0], setType = _h[1];
    var _j = useState(null), alert = _j[0], setAlert = _j[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        body = { vendor: vendor, name: name, catalog: catalog, unit: unit, price: price, type: type, url: url };
                        return [4 /*yield*/, fetchPostJsonQueryStatus(ADD_INVENTORY_ITEM_URL, body, config)];
                    case 1:
                        alert = _a.sent();
                        setAlert(alert);
                        return [2 /*return*/];
