...
function DayInput({ id, date, onDateChange }) {
    ...
    return (_jsxs(BaseRow, { children: [_jsx("input", { id: id, type: "text", "aria-label": "Date", value: dateValue, className: clns("w-20 bg-transparent outline-none"), 
                //onClick={_onClick}
