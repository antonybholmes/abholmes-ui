...
export default function LogoIcon(_a) {
    ...
    return (_jsx(BaseLink, { "aria-label": APP_NAME, href: "/", className: clns(CENTERED_BUTTON_CLS, "fill-sky-500 dark:fill-gray-100", className), children: _jsx(BioIcon, { size: size }) }));
}
