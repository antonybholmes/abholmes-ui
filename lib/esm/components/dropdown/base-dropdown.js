...
export var BASE_DROPDOWN_CLS = cn("absolute mt-2 shadow-lg border border-slate-200/80 z-overlay text-sm gap-y-4 dark:border-none min-w-full", DROPDOWN_BG_CLS, ROUNDED_CLS);
export function BaseDropDown(_a) {
    ...
    return (_jsxs("div", { ref: ref, className: cn("relative", className), onKeyDown: onKeyDown, children: [c[0], (dropDownVisible || !hide) && (_jsx(BaseCol, { className: cn(BASE_DROPDOWN_CLS, "duration-300 ease-in-out fill-mode-forwards", [
                    dropDownVisible,
