...
//   },
// }
export default function LMTooltip(_a) {
    ...
    // //   leave: { opacity: 0 },
    // // })
    return (_jsx(TooltipProvider, { children: _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: children }), _jsx(TooltipContent, { side: "bottom", children: _jsx("p", { children: content }) })] }) }));
}
