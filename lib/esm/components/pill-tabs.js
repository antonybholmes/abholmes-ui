...
export var PILL_CLS = cn(BASE_BUTTON_CLS, FOCUS_RING_CLS, PILL_BUTTON_CLS, CENTERED_BUTTON_CLS, "px-4 py-2 text-xs font-bold");
export var SELECTED_PILL_CLS = "trans-300 absolute bottom-0 left-0 top-0 z-0 block h-full rounded-full bg-theme-100 transition-all dark:bg-gray-600";
export default function PillTabs(_a) {
    var tabs = _a.tabs, _b = _a.activeTabIndex, activeTabIndex = _b === void 0 ? 0 : _b, onTabClick = _a.onTabClick;
    ...
    return (_jsx(_Fragment, { children: _jsxs(BaseCol, { className: "gap-y-1", children: [_jsxs("div", { className: "relative", children: [_jsx(BaseRow, { className: "relative z-10 gap-x-1", children: tabs.map(function (tab, idx) {
                                return (_jsx(BaseButton, { ref: function (el) { return (tabsRef.current[idx] = el); }, className: cn(PILL_CLS, [
                                        idx === activeTabIndex,
