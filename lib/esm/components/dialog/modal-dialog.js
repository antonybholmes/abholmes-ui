...
export default function ModalDialog({ visible = false, onCancel, className, children, }) {
    ...
    if (visible || !hide) {
        return (_jsx(ModalBgScreen, { visible: visible, onClick: (e) => onCancel && onCancel(e), className: "flex flex-row items-center justify-center", children: _jsx("div", { className: clns("flex flex-col rounded-lg bg-white p-6 shadow-lg dark:bg-gray-700", className), onClick: e => 
