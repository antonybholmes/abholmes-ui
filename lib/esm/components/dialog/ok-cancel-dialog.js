...
export default function OKCancelDialog(_a) {
    var title = _a.title, text = _a.text, visible = _a.visible, onClick = _a.onClick, onCancel = _a.onCancel, className = _a.className;
