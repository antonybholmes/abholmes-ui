...
export default function TextDialog(_a) {
    var title = _a.title, text = _a.text, visible = _a.visible, onCancel = _a.onCancel, className = _a.className, children = _a.children;
    return (
    // <DynamicModal
    //   visible={visible}
    //   onCancel={onCancel}
