...
export default function AutocompleteSelect(_a) {
    ...
    return (_jsxs(BaseCol, { className: clns("gap-y-2 py-2", className), children: [_jsxs(BaseDropDown, { dropDownVisible: dropDownVisible, onClose: onClose, menuClassName: clns(DROPDOWN_CLS, "w-full"), children: [_jsx(BaseRow, { children: _jsxs(BaseButton, { onClick: function () { return setDropDownVisible(!dropDownVisible); }, "aria-label": "Show ".concat(name), className: clns(ROUNDED_BUTTON_CLS, "w-full gap-x-4 p-1 text-left"), children: [_jsx("p", { className: "grow", children: name }), _jsx(ChevronRightIcon, { className: clns("trans-300 transition-transform", CHEVRON_CLS, [
                                        dropDownVisible,
                                        "rotate-270",
                                        "rotate-90",
