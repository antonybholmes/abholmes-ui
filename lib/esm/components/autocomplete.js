...
export default function Autocomplete(_a) {
    ...
    // >
    _jsxs(_Fragment, { children: [_jsxs(Popover, { open: dropDownVisible, children: [_jsx(PopoverAnchor, { asChild: true, children: _jsx("span", {}) }), _jsxs(PopoverContent, { onInteractOutside: function () { return _onClose(); }, onEscapeKeyDown: function () { return _onClose(); }, className: clns("text-sm", menuClassName), sideOffset: 6, children: [_jsx(BaseSearchBar, { id: id, onChange: _onChange, placeholder: placeholder, search: text, onClearClick: function (e) {
                                    e.preventDefault();
                                    //_onValueChange("")
                ...
                className: clns(INPUT_CLS, "h-10 w-full", className), placeholder: placeholder, value: text, onFocus: function () { return setDropDownVisible(true); } })] }));
}
