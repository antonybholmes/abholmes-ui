...
export default function useFetch(url, params) {
    ...
    var fetchData = function (url, params) { return __awaiter(_this, void 0, void 0, function () {
...
export function useGetFetch(url, params) {
    return useFetch(url, __assign(__assign({}, params), { method: "GET" }));
}
export function usePostFetch(url, body, headers) {
    return useFetch(url, { body: JSON.stringify(body), headers: headers, method: "POST" });
}
export function useQueryPostFetch(url, body, headers) {
    ...
    var _c = usePostFetch(url, body, headers), data = _c.data, loading = _c.loading, error = _c.error;
    useEffect(function () {
