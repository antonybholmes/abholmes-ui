...
export const FORM_DIV_CLS = cn("p-4 lg:p-8 flex flex-col gap-y-4 rounded-lg border", INPUT_DARK_BORDER_CLS);
...
export const INPUT_CLS = cn(FOCUS_RING_CLS, INPUT_BORDER_CLS, INPUT_DARK_BORDER_CLS, "outline-none border-b py-1 text-sm");
export const TABLE_CLS = "text-sm";
export const TD_CLS = "p-2 align-top";
export const TH_CLS = cn(TD_CLS, "text-left font-bold text-xs text-gray-500 dark:text-gray-200");
...
export const SIDE_DROPDOWN_CLS = cn("border-b border-gray-200", INPUT_DARK_BORDER_CLS);
