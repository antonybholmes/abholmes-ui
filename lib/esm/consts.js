...
export var ORDER_ITEM_TEXT = "Order Item";
export var ORDER_BUTTON_TEXT = "Order";
...
export var INPUT_CLS = cn(FOCUS_RING_CLS, INPUT_BORDER_CLS, INPUT_DARK_BORDER_CLS, "outline-none border-b py-1 text-sm");
...
export var FILTER_BUTTON_CLS = "px-2 py-1.5 text-theme-500 border border-theme-300 rounded-full";
