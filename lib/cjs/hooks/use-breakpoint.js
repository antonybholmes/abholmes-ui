...
const use_window_size_1 = __importDefault(require("./use-window-size"));
...
function useBreakPoint() {
    const windowSize = (0, use_window_size_1.default)();
    const [breakPoint, setBreakpoint] = (0, react_1.useState)(exports.BREAKPOINTS["sm"]);
    (0, react_1.useEffect)(() => {
