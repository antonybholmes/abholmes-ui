...
exports.FORM_CLS = (0, class_names_1.cn)(exports.BASE_FORM_CLS, "w-11/12 lg:w-1/2");
exports.FORM_DIV_CLS = (0, class_names_1.cn)("p-4 lg:p-8 flex flex-col gap-y-4 rounded-lg border", _theme_1.INPUT_DARK_BORDER_CLS);
...
exports.INPUT_CLS = (0, class_names_1.cn)(_theme_1.FOCUS_RING_CLS, _theme_1.INPUT_BORDER_CLS, _theme_1.INPUT_DARK_BORDER_CLS, "outline-none border-b py-1 text-sm");
exports.TABLE_CLS = "text-sm";
exports.TD_CLS = "p-2 align-top";
exports.TH_CLS = (0, class_names_1.cn)(exports.TD_CLS, "text-left font-bold text-xs text-gray-500 dark:text-gray-200");
...
exports.SIDE_DROPDOWN_CLS = (0, class_names_1.cn)("border-b border-gray-200", _theme_1.INPUT_DARK_BORDER_CLS);
