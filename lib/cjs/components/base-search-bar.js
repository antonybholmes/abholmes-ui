...
function BaseSearchBar({ id, search, placeholder, onChange, onClick, onClearClick, onKeyDown, showClearButton = false, onFocus, onBlur, className, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(v_center_row_1.default, { className: (0, class_names_1.clns)("group shrink-0 gap-x-1", className), onFocus: _onFocus, onBlur: onBlur, children: [(0, jsx_runtime_1.jsx)(base_button_1.BaseButton, { onClick: onClick, "aria-label": "Search", className: (0, class_names_1.clns)("focus-visible:bg-accent", theme_1.ICON_BUTTON_CLS), children: (0, jsx_runtime_1.jsx)(search_1.SearchIcon, { className: "trans-300 transition-color fill-gray-500 group-hover:fill-gray-800 dark:fill-gray-500 dark:group-hover:fill-gray-400" }) }), (0, jsx_runtime_1.jsx)("input", { ref: ref, id: id, name: id, onChange: onChange, onKeyDown: onKeyDown, "aria-label": "Search", className: "w-full grow bg-transparent outline-none", placeholder: placeholder, value: search, autoFocus: true }), showClearButton && search.length > 0 && ((0, jsx_runtime_1.jsx)(base_button_1.BaseButton, { onClick: onClearClick, "aria-label": "Search", className: (0, class_names_1.clns)("focus-visible:bg-accent", theme_1.ICON_BUTTON_CLS), children: (0, jsx_runtime_1.jsx)(close_1.CloseIcon, { className: "trans-300 transition-color stroke-gray-500 stroke-2 group-hover:stroke-gray-800 dark:stroke-gray-500 dark:group-hover:fill-gray-400" }) }))] }));
}
