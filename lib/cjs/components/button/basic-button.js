...
exports.BasicButton = (0, react_1.forwardRef)(function BasicButton({ className, children, ...props }, ref) {
    return ((0, jsx_runtime_1.jsx)(base_button_1.BaseButton, { ref: ref, className: (0, class_names_1.default)(theme_1.FOCUS_RING_CLS, className), ...props, children: children }));
});
