...
function BlueLinkButton({ className, children, ...props }) {
    return ((0, jsx_runtime_1.jsx)(basic_button_1.BasicButton, { className: (0, class_names_1.clns)(theme_1.PRIMARY_LINK_CLS, "font-medium", className), ...props, children: children }));
}
