...
const ToolbarIconButton = (0, react_1.forwardRef)(function ToolbarIconButton({ className, children, ...props }, ref) {
    return ((0, jsx_runtime_1.jsx)(toolbar_button_1.default, { ref: ref, size: "icon", className: (0, class_names_1.cn)(theme_1.TOOLBAR_ICON_BUTTON_CLS, className), ...props, children: children }));
});
