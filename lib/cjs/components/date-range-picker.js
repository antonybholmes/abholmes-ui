...
const DAY_BUTTON_CLS = (0, class_names_1.clns)(theme_1.CENTERED_BUTTON_CLS, theme_1.PILL_BUTTON_CLS, SIZE, theme_1.FOCUS_BORDER_CLS, theme_1.PRIMARY_FOCUS_BORDER_CLS, "relative shrink-0 grow-0 border-2");
function MonthView({ date, now, dateRange, rangeMode, onDayClick, onDayHover, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(base_col_1.BaseCol, { className: "gap-y-2", onMouseEnter: () => setHover(true), onMouseLeave: () => setHover(false), children: [(0, jsx_runtime_1.jsx)(h_center_row_1.default, { children: (0, date_fns_1.format)(date, "LLLL") }), (0, jsx_runtime_1.jsxs)("div", { className: "grid grid-cols-7 gap-y-1 ", style: { width: W }, children: [SHORT_DAYS.map((day, di) => ((0, jsx_runtime_1.jsx)("div", { className: (0, class_names_1.clns)(theme_1.CENTERED_BUTTON_CLS, SIZE, "text-xs font-semibold text-slate-400 dark:text-gray-400"), children: day }, di))), days.map((day, di) => {
...
function DateRangePicker({ currentDateRange, onDatesChange, onClose, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "p-2", children: [(0, jsx_runtime_1.jsxs)("nav", { className: "flex flex-row items-center justify-center gap-x-1 font-semibold", onClick: () => setYearMode(false), children: [(0, jsx_runtime_1.jsx)(toolbar_icon_button_1.default, { onClick: displayPrevMonth, "aria-label": "Previous month", children: (0, jsx_runtime_1.jsx)(chevron_right_1.ChevronRightIcon, { className: (0, class_names_1.clns)(consts_1.CHEVRON_CLS, "rotate-180"), size: "w-3" }) }), (0, jsx_runtime_1.jsx)(toolbar_button_1.default, { onClick: toggleYearSelector, "aria-label": "Change year", children: startMonthDate.getFullYear() }), (0, jsx_runtime_1.jsx)(toolbar_icon_button_1.default, { onClick: displayNextMonth, "aria-label": "Next month", children: (0, jsx_runtime_1.jsx)(chevron_right_1.ChevronRightIcon, { className: consts_1.CHEVRON_CLS, size: "w-3" }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "relative py-2", children: [(0, jsx_runtime_1.jsxs)(base_row_1.BaseRow, { className: "gap-x-8", children: [(0, jsx_runtime_1.jsx)(MonthView, { date: startMonthDate, dateRange: highlightDateRange, rangeMode: rangeMode, now: now, onDayClick: onStartDayClick, onDayHover: onDayHover }), (0, jsx_runtime_1.jsx)(MonthView, { date: endMonthDate, dateRange: highlightDateRange, rangeMode: rangeMode, now: now, onDayClick: onStartDayClick, onDayHover: onDayHover })] }), (0, jsx_runtime_1.jsx)("div", { className: "px-2 py-2", children: (0, jsx_runtime_1.jsx)(blue_link_button_1.BlueLinkButton, { onClick: (e) => onDateClick(new Date()), "aria-label": "Today", className: "text-sm", children: "Today" }) }), yearMode && ((0, jsx_runtime_1.jsx)("ul", { ref: yearMenuRef, className: "bg-popover absolute left-0 top-0 flex h-full w-full flex-col overflow-y-auto font-semibold", children: years.map(year => ((0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsx)(base_button_1.BaseButton, { id: `year-${year}`, className: (0, class_names_1.clns)(theme_1.MENU_BUTTON_CLS, "shrink-0", [
