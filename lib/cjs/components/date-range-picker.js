...
const DAY_BUTTON_CLS = (0, class_names_1.default)(theme_1.CENTERED_BUTTON_CLS, theme_1.PILL_BUTTON_CLS, SIZE, theme_1.FOCUS_BORDER_CLS, theme_1.PRIMARY_FOCUS_BORDER_CLS, "relative shrink-0 grow-0 border-2");
function MonthView({ date, now, dateRange, rangeMode, onDayClick, onDayHover, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(base_col_1.default, { className: "gap-y-2", onMouseEnter: () => setHover(true), onMouseLeave: () => setHover(false), children: [(0, jsx_runtime_1.jsx)(h_center_row_1.default, { children: (0, date_fns_1.format)(date, "LLLL") }), (0, jsx_runtime_1.jsxs)("div", { className: "grid grid-cols-7 gap-y-1 ", style: { width: W }, children: [SHORT_DAYS.map((day, di) => ((0, jsx_runtime_1.jsx)("div", { className: (0, class_names_1.default)(theme_1.CENTERED_BUTTON_CLS, SIZE, "text-xs font-semibold text-slate-400 dark:text-gray-400"), children: day }, di))), days.map((day, di) => {
                        ...
                        return ((0, jsx_runtime_1.jsxs)("div", { className: (0, class_names_1.default)("relative text-xs", SIZE, theme_1.CENTERED_BUTTON_CLS, [highlighted, "bg-theme-100 dark:bg-gray-600 "], [di % 7 === 0 || day.date.getDate() === 1, "rounded-l-full"], [
