...
const base_col_1 = require("@components/base-col");
...
exports.PILL_CLS = (0, class_names_1.cn)(_theme_1.BASE_BUTTON_CLS, _theme_1.FOCUS_RING_CLS, _theme_1.PILL_BUTTON_CLS, _theme_1.CENTERED_BUTTON_CLS, "px-4 py-2 text-xs font-bold");
...
function PillTabs({ tabs, activeTabIndex = 0, onTabClick, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)(base_col_1.BaseCol, { className: "gap-y-1", children: [(0, jsx_runtime_1.jsxs)("div", { className: "relative", children: [(0, jsx_runtime_1.jsx)(base_row_1.BaseRow, { className: "relative z-10 gap-x-1", children: tabs.map((tab, idx) => {
                                return ((0, jsx_runtime_1.jsx)(base_button_1.BaseButton, { ref: (el) => (tabsRef.current[idx] = el), className: (0, class_names_1.cn)(exports.PILL_CLS, [
                                        idx === activeTabIndex,
