...
function defaultRenderListItem(index, id, label, item, onClick) {
    ...
    return ((0, jsx_runtime_1.jsx)(menu_button_1.default, { onClick: function (e) { return _onClick(e); }, "aria-label": label, children: (0, jsx_runtime_1.jsx)("span", { children: label }) }));
}
