...
function ModalDialog({ visible = false, onCancel, className, children, }) {
    ...
    if (visible || !hide) {
        return ((0, jsx_runtime_1.jsx)(modal_bg_screen_1.default, { visible: visible, onClick: (e) => onCancel && onCancel(e), className: "flex flex-row items-center justify-center", children: (0, jsx_runtime_1.jsx)("div", { className: (0, class_names_1.default)("flex flex-col rounded-lg bg-white p-6 shadow-lg dark:bg-gray-700", className), onClick: e => 
