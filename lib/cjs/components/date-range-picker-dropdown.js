...
function DayInput({ id, date, onDateChange }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(base_row_1.BaseRow, { children: [(0, jsx_runtime_1.jsx)("input", { id: id, type: "text", "aria-label": "Date", value: dateValue, className: (0, class_names_1.clns)("w-20 bg-transparent outline-none"), 
                //onClick={_onClick}
