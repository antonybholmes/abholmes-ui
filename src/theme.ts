...
export const BASE_INPUT_DARK_CLS = clns(
...
export const INPUT_DARK_CLS = clns(
  INPUT_BORDER_CLS,
  BASE_INPUT_DARK_CLS,
...
export const ICON_BUTTON_SIZE_CLS = clns("shrink-0", BUTTON_W_CLS, BUTTON_H_CLS)
export const PRIMARY_BUTTON_W_CLS = "min-w-24"
export const DEFAULT_BUTTON_SIZE_CLS = clns(BUTTON_H_CLS, "px-4 py-2")

export const PRIMARY_TEXT_CLS = "text-primary"
export const PRIMARY_LINK_CLS = clns(PRIMARY_TEXT_CLS, "hover:text-primary")
...
export const BASE_BUTTON_CLS = clns(
  ROW_BUTTON_CLS,
...
export const ICON_BUTTON_CLS = clns("justify-center", ICON_BUTTON_SIZE_CLS)

//export const FOCUS_BUTTON_CLS = clns(BASE_BUTTON_CLS, FOCUS_RING_CLS)

export const BASE_PRIMARY_BUTTON_CLS = clns(
  FOCUS_RING_CLS,
  ROUNDED_BUTTON_CLS,
  "font-medium",
)

export const PRIMARY_BUTTON_CLS = clns(
  ROUNDED_BUTTON_CLS,
  "bg-primary text-primary-foreground/95 shadow hover:bg-primary/90 justify-center",
)

export const SECONDARY_BUTTON_CLS = clns(
  ROUNDED_BUTTON_CLS,
  "bg-accent text-secondary-foreground shadow-sm hover:bg-accent/80 justify-center",
)

export const BASE_TOOLBAR_BUTTON_CLS = clns(
  BUTTON_H_CLS,
  ROW_BUTTON_CLS,
  FOCUS_RING_CLS,
  "hover:bg-accent",
...
export const TOOLBAR_ICON_BUTTON_CLS = clns(
...
export const TOOLBAR_BUTTON_CLS = clns(
  BASE_TOOLBAR_BUTTON_CLS,
  BUTTON_PADDING,
  ROUNDED_BUTTON_CLS,
  "justify-center",
...
export const MENU_BUTTON_CLS = clns(
  BASE_TOOLBAR_BUTTON_CLS,
  ROUNDED_BUTTON_CLS,
  BUTTON_PADDING,
