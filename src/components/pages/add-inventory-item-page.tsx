...
export default function AddInventoryItemPage({
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const body = { vendor, name, catalog, unit, price, type, url }

    const alert = await fetchPostJsonQueryStatus(
      ADD_INVENTORY_ITEM_URL,
      body,
      config,
    )
  ...
  return (
    <>
      <Toolbar session={session} tab="Add Inventory Item" alert={alert} />
      ...
      <div className={CENTER_CONTENT_CLS}>
        <form
          ...
          onSubmit={onSubmit}
        >
          <h1 className="text-lg font-bold">Add Inventory Item</h1>
