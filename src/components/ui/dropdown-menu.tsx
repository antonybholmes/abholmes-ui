...
>(({ className, inset, children, ...props }, ref) => {
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        BUTTON_H_CLS,
        "focus:bg-accent focus:text-accent-foreground relative flex cursor-default select-none flex-row items-center gap-x-2 rounded-sm px-2 text-sm outline-none transition-colors data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        inset && "pl-8",
        className,
      )}
      {...props}
